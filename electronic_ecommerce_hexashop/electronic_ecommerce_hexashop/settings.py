"""
Django settings for electronic_ecommerce_hexashop project.
...
SECRET_KEY = 'django-insecure-=7we1nglhw-*=d)%ycg*(+$v7-q1jr7q%9h*k$uh0^6u1$(q%d'
...
ROOT_URLCONF = 'electronic_ecommerce_hexashop.urls'
...
WSGI_APPLICATION = 'electronic_ecommerce_hexashop.wsgi.application'
